import { AdbPacketHeader, AdbPacketSerializeStream, DuplexStreamFactory, pipeFrom, ReadableStream, WritableStream } from '@yume-chan/adb';
...
export class AdbWebUsbBackendStream {
    ...
    constructor(device, inEndpoint, outEndpoint) {
        ...
        this._writable = pipeFrom(factory.createWritable(new WritableStream({
            write: async (chunk) => {
